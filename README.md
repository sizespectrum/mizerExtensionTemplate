...
Every extension mechanism described in the mizer documentation is illustrated
with working, commented code:
...
- **Dispatching** (like this template and
  ...
  `NextMethod()`.
- **Metadata-only** (like
  [mizerStarvation](https://sizespectrum.org/mizerStarvation/)): records the
  extension dependency without overriding any generic. Comments in the
  constructor explain which parts to keep or drop for this case.
